...
int	main(void)
{
	...
	char str5[10] = {16, 31, 123, 67} ;
	char str6[10] = "";
	
	int test1 = ft_str_is_printable(str1);
	int test2 = ft_str_is_printable(str2);
	int test3 = ft_str_is_printable(str3);
	int test4 = ft_str_is_printable(str4);
	int test5 = ft_str_is_printable(str5);
	int test6 = ft_str_is_printable(str6);
