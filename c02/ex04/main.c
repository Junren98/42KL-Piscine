...
int	main(void)
{
	...
	int test1 = ft_str_is_lowercase(str1);
	int test2 = ft_str_is_lowercase(str2);
	int test3 = ft_str_is_lowercase(str3);
	int test4 = ft_str_is_lowercase(str4);
	int test5 = ft_str_is_lowercase(str5);
	int test6 = ft_str_is_lowercase(str6);
