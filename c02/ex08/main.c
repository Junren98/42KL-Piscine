...
int	main(void)
{
	...
	test_str1 = ft_strlowcase(str1);
	test_str2 = ft_strlowcase(str2);
	test_str3 = ft_strlowcase(str3);
	test_str4 = ft_strlowcase(str4);
	test_str5 = ft_strlowcase(str5);
	test_str6 = ft_strlowcase(str6);
	printf("the string of str1 is %s \n", test_str1); 
	printf("the string of str2 is %s \n", test_str2); 
	printf("the string of str3 is %s \n", test_str3); 
	printf("the string of str4 is %s \n", test_str4); 
